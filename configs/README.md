...
- `tools.yaml`: external scientific tool paths, images, timeouts, model requirements, and pinned source metadata. Runtime environment variables override these values.
